---
name: appstore-whatsnew
description: "Summarize what changed between the last two version tags of an iOS project. Reads git commits and prints a categorized release summary plus a paste-ready App Store Connect 'What's New' block. Pure git-based, no API calls. Usage: /appstore-whatsnew"
user_invocable: true
---

# /appstore-whatsnew — Release Summary from Git
...
End the message with one line: **"Run `/appstore-whatsnew` again after your next release to regenerate."**
